...
public class FlightRotationController : MonoBehaviour
{
    ...
    public static event Action<Quaternion> OnQuaternionCalculateFinish;
    ...
    void Update()
    {
        ...
        {
            ProcessFlightRotation();
        }
    }

    /// <summary>
    /// MPU6050 센서 데이터와 상보 필터를 이용해 비행기의 절대 회전값을 계산하고 적용합니다.
    /// </summary>
    private void ProcessFlightRotation()
    {
